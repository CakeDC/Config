...
* The master branch holds the STABLE latest version of the plugin. [![Build Status](https://travis-ci.org/CakeDC/Config.png?branch=master)](https://travis-ci.org/CakeDC/Config)
* Develop branch is UNSTABLE and used to test new features before releasing them. [![Build Status](https://travis-ci.org/CakeDC/Config.png?branch=develop)](https://travis-ci.org/CakeDC/Config)
